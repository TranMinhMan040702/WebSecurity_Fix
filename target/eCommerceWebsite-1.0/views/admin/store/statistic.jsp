            ...
            <div class="iq-card-body">
              <div class="table-responsive">
                <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid"
                  ...
                  <tbody>
                  <c:forEach items="${storeListTop10}" var="stores" varStatus="STT" >
                    <tr class="text-center">
                      <td>${STT.index + 1 }</td>
                      <td>${stores.name}</td>
                      <td>${stores.bio}</td>
...
<script>
  window.onload = function() {
    ...
    var chart1 = new CanvasJS.Chart("chartContainerCircle", {
      ...
      title: {
        text: "TÌNH TRẠNG CỬA HÀNG TRÊN HỆ THỐNG",
        padding: "15",
        fontSize: 20,
        fontFamily: "tahoma",
        fontWeight: 700,
      ...
      data: [{
        ...
        indexLabel: "{label} {y}",
        dataPoints: [
          {y: (open/total)*100, label: "Đang hoạt động"},
          {y: 100 - (open/total)*100, label: "Đang tạm ngưng"}
        ]
      }]
    });
    var chart2 = new CanvasJS.Chart("chartContainerColumn", {
      ...
      data: [{
        ...
        legendText: "Tổng số cửa hàng tại thời điểm",
        showInLegend: true,
        dataPoints:[
        ...
        {
          type: "column",
          name: "Số cửa hàng mới trong tháng",
          legendText: "Số cửa hàng mới trong tháng",
          showInLegend: true,
          dataPoints:[
